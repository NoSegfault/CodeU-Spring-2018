...
//
//  @Test
//  public void testDoPost_ExistingUser_CorrectPassword() throws IOException, ServletException {
//    Mockito.when(mockRequest.getParameter("username")).thenReturn("test username");
//
//    UserStore mockUserStore = Mockito.mock(UserStore.class);
...
//
//  @Test
//  public void testDoPost_ExistingUser_IncorrectPassword() throws IOException, ServletException {
//    Mockito.when(mockRequest.getParameter("username")).thenReturn("test username");
//
//    UserStore mockUserStore = Mockito.mock(UserStore.class);
//    Mockito.when(mockUserStore.isUserRegistered("test username")).thenReturn(true);
...
//    User mockUser = mockUserStore.getUser("test username");
//    String mockPassword = mockUser.getPassword();
//    Mockito.when(BCrypt.checkpw(mockPassword,mockUser.getPassword())).thenReturn(false);
//
//    loginServlet.doPost(mockRequest, mockResponse);
//
//    Mockito.verify(mockUserStore, Mockito.never()).addUser(Mockito.any(User.class));
